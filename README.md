...
const aditya = {
    ...
    currentFocus: ["Java Development", "Python for AI/ML", "Advanced ML Models"],
    openTo: ["Hackathons", "Full-Stack Opportunities", "AI/ML Collaborations", "Open Source"],
    philosophy: "Building solutions that create measurable impact"
};
```
